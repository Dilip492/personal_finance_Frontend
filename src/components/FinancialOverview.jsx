    ...
    <div className="bg-white p-6 rounded-lg shadow-md">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <div className="bg-green-100 p-4 rounded-lg">
          <h3 className="text-sm text-green-800">Total Income</h3>
          <p className="text-2xl font-bold text-green-600">$8,500</p>
        </div>
        <div className="bg-red-100 p-4 rounded-lg">
          <h3 className="text-sm text-red-800">Total Expenses</h3>
          <p className="text-2xl font-bold text-red-600">$2,700</p>
        </div>
        <div className="bg-blue-100 p-4 rounded-lg">
          <h3 className="text-sm text-blue-800">Current Balance</h3>
